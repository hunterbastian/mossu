...
- cooler blue-green water with profile-driven shoreline definition, stronger lake-edge foam, milkier still-pool banks, clearer shallow/mid/deep depth bands, brighter but controlled current/specular strokes, downstream current threads, lens-current ribbons, bend eddies, bank laps, traveling caustics, and longer Mossu/Karu ripple rings

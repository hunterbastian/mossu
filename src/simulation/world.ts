...
const ISLAND_RADIUS_X = 680;
const ISLAND_RADIUS_Z = 700;
const ISLAND_SUPERELLIPSE_EXPONENT = 3.0;
...
const ISLAND_CLIFF_DROP_BASE = 48;
const ISLAND_CLIFF_DROP_STEEP = 218;
...
export function sampleBaseTerrainHeight(x: number, z: number) {
  ...
  const fineSurface =
    fbmNoise(x * 0.045 - 3.4, z * 0.045 + 5.2, 3) * (0.9 + highlandMask * 1.9) * (1 - routeSmooth * 0.78) * t;
...
export const worldForageables: WorldForageable[] = [
  {
    ...
    interactionRadius: FORAGEABLE_INTERACTION_RADIUS,
  },
  {
    id: "lake-shell",
    kind: "shell",

...
export const ROLL_EXIT_CARRY_TIME = 0.34;
export const ROLL_EXIT_SPEED_CARRY_BONUS = 18;
...
export const FLOAT_EXIT_GRAVITY_GRACE_TIME = 0.22;
export const FLOAT_EXIT_GRAVITY_SCALE = 0.54;
...
export const SWIM_ENTRY_MOMENTUM_GRACE_TIME = 0.42;
export const SWIM_ENTRY_SPEED_CARRY_BONUS = 8.2;

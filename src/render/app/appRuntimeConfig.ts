...
export const MIN_PIXEL_RATIO = 0.62;
export const LOW_QUALITY_MIN_PIXEL_RATIO = 0.25;
export const PIXEL_RATIO_DOWNSHIFT_FRAME_SECONDS = 1 / 48;
export const PIXEL_RATIO_UPSHIFT_FRAME_SECONDS = 1 / 58;
export const PIXEL_RATIO_STEP_DOWN = 0.18;
export const PIXEL_RATIO_STEP_UP = 0.04;
export const NORMAL_HUD_UPDATE_INTERVAL = 1 / 12;
export const BLOOM_STRENGTH = 0.17;
export const BLOOM_RADIUS = 0.44;

...
const RETRO_TEXTURE_SCANLINE_STRENGTH = 0.032;
const RETRO_TEXTURE_VIGNETTE_STRENGTH = 0.036;
const RETRO_TEXTURE_QUANTIZE_STRENGTH = 0.14;
const RETRO_TEXTURE_PIXEL_BLOCK = 1.18;
const RETRO_TEXTURE_CHROMA_STRENGTH = 0.00055;
const RETRO_TEXTURE_TONE_STRENGTH = 0.1;

...
export const WATER_PROFILES: Record<WaterProfileKey, WaterProfile> = {
  ...
  mainRiver: {
    ...
    currentStrokeStrength: 0.78,
    heroSpecularStrength: 0.65,
  },
  stillPool: {
    key: "stillPool",
    widthScale: 1,
    ...
    shorelineDefinition: 1.15,
    depthBandStrength: 1.12,
    currentStrokeStrength: 0.55,
    heroSpecularStrength: 1.1,
  },
  foothillCreek: {
    key: "foothillCreek",
    widthScale: 0.92,
